...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-4">
                <div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
                    <a href="<?php echo e(route("backend.$module_name.index")); ?>" class="btn btn-secondary btn-sm ml-1" data-toggle="tooltip" title="<?php echo e($module_title); ?> List"><i class="fas fa-list-ul"></i> List</a>
                </div>
            </div>
            <!--/.col-->
        </div>
        ...
        <div class="row mt-4">
            <div class="col">
                <?php echo e(html()->form('POST', route("backend.$module_name.store"))->acceptsFiles()->class('form')->open()); ?>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <?php echo e(html()->button($text = "<i class='fas fa-plus-circle'></i> " . ucfirst($module_action) . "", $type = 'submit')->class('btn btn-success')); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xamp\htdocs\laravel\laravel-articles\Modules/Tag\Resources/views/backend/tags/create.blade.php ENDPATH**/ ?>