        ...
        <div class="row">
            <div class="col-8">
                <h4 class="card-title mb-0">
                    <i class="<?php echo e($module_icon); ?>"></i> <?php echo e($module_title); ?> <small class="text-muted">Data Table <?php echo e($module_action); ?></small>
                </h4>
                <div class="small text-muted">
                    <?php echo e(Str::title($module_name)); ?> Management Dashboard
                </div>
            </div>
            <div class="col-4">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xamp\htdocs\laravel\laravel-articles\resources\views/modules/tag/backend/tags/index_datatable.blade.php ENDPATH**/ ?>