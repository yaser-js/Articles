...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mt-4">
            <div class="col">
                <?php echo e(html()->form('POST', route("backend.$module_name.store"))->class('form')->open()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xamp\htdocs\laravel\laravel-articles\resources\views/modules/article/backend/posts/create.blade.php ENDPATH**/ ?>