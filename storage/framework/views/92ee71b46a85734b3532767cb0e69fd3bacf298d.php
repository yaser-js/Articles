    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 text-center">
                <div class="mb-2">
                    <a href="<?php echo e(route('frontend.categories.index')); ?>" class="badge badge-sm badge-warning text-uppercase px-3">
                        Category
                    </a>
                </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xamp\htdocs\laravel\laravel-articles\Modules/Article\Resources/views/frontend/categories/show.blade.php ENDPATH**/ ?>