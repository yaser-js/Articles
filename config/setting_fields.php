    ...
    'app' => [
        ...
        'elements' => [
            [
                ...
                'value' => 'Laravel template', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'string', // data type, string, int, boolean
    ...
    'meta' => [
        ...
        'elements' => [
            [
                ...
                'class' => '', // any class for input
                'value' => 'Awesome Laravel ', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
            ...
            [
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'Web Application, Laravel,Laravel ,Bootstrap,Admin,Template', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
